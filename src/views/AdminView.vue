  ...
  <aside id="sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-violet dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="/admin/calendar" class="flex items-center p-2 text-s text-white hover:bg-gradient-to-l from-grad hover:border-r-8 border-pink-300">
            <img src="/calendar.svg" class="pr-3" alt="" />
            Calendar
          </a>
        </li>
        <li>
          <RouterLink to="/admin/profile" class="flex items-center p-2 text-s text-white hover:bg-gradient-to-l from-grad hover:border-r-8 border-pink-300">
      ...
      <ul class="bottom-10 space-y-2 font-medium mt-20">
          <li>
          <a href="#" class="flex items-center p-2 text-s text-white hover:bg-gradient-to-l from-grad hover:border-r-8 border-pink-300">
            <span class="flex-1 ml-3 whitespace-nowrap">About</span>
          </a>
        </li>

        <li>
          <a href="#" class="flex items-center text-s p-2 text-white dark:text-white hover:bg-gradient-to-l from-grad hover:border-r-8 border-pink-300">
