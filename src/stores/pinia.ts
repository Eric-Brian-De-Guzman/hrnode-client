...
export const useUserStore = defineStore(
  ...
  () => {
    ...
    function setUser(input: any) {
      ...
      jwt.value = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJjYmI3NDYyZC1lYjcwLTRlNjYtYjUyMi1mNzc2MTcwNGU1ODMiLCJpYXQiOjE2ODczMzI2ODgsImV4cCI6MTY4NzMzNjI4OH0.qEcpNrqXM-xPxOqcfqzU4Q2LqLpGe-TtIl5FuiQ0t3k";
    }
